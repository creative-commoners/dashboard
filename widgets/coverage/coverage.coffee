# Based on https://github.com/jorgemorgado/dashing-barchart
class Dashing.Coverage extends Dashing.Widget
  ...
  ready: ->
    ...
    top = 40 # @get('topMargin') || 0
    bottom = 40 # @get('bottomMargin') || top
    ...
    # See https://www.chartjs.org/docs/latest/charts/bar.html - note that some options
    # are passed in from coverage.rb
